...
export default function AuthBanner() {
  ...
  return (
    <div className="sticky top-0 z-50 bg-background py-6 px-6">
      <div className=" bg-amber-500/5 dark:bg-amber-500/5 dark:border-amber-500 border border-amber-500 shadow-md rounded-xl">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-start space-x-3 flex-1">
            ...
            <div className="flex-1">
              ...
              <ol className="text-sm text-amber-500 list-decimal list-inside space-y-1 mb-3">
                <li>Enter your OpenAI API key or connect an instance of LM Studio running on your machine with a model o</li>
