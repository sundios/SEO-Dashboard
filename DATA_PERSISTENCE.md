...
- **LM Studio Integration**: Use the LLM model of your choice with LM Studio and instantly add trend analaysis to your reports
- **Print to PDF**: Print individual report pages to high resolution PDF
- **GSC Domain-wide Property discovery:** Discover and report on domain-wide properties in Goohgle Search Console (properyties that don't start with www, hhtp, or https)
